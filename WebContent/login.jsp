...
<body
	style="background-color: #202020; background-image: url('images/Oraclemovieplex_1000x750.png'); background-position: center;">
	<div class="container">
		<div id="content">
			<div id="login-box" class="login-popup"
				style="display: block; position: absolute; top: 25px; right: 25px; width: 250px; left: auto;">
				<%
				...
				<form method="post" class="signin" action="login">
					<fieldset class="textbox">
						...
						<p>
							<span><input type="checkbox" name="useMoviePosters"
								value="useMoviePosters" checked="yes"> Use movie posters</span>
						</p>
					</fieldset>
				</form>
			</div>
